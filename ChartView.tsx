...
// as the output, which is everything the orchestrator can know about what is drawn.
...
function Chart({
  ...
  const url = state.symbol ? widgetUrl(state) : null;
  ...
  // Another address is another chart: what the last one said about its price no longer holds.
  useEffect(() => {
    latest.current = null;
